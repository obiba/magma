...
CREATE TABLE variables(DATASOURCE VARCHAR(255) NOT NULL, VALUE_TABLE VARCHAR(255) NOT NULL, NAME VARCHAR(255) NOT NULL, VALUE_TYPE VARCHAR(255), MIME_TYPE VARCHAR(255), UNITS VARCHAR(255), IS_REPEATABLE BOOLEAN NOT NULL, OCCURRENCE_GROUP VARCHAR(255), SQL_NAME VARCHAR(255) NOT NULL, PRIMARY KEY(DATASOURCE, VALUE_TABLE, NAME));
