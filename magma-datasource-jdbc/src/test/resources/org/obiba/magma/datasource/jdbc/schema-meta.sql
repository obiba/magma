...
CREATE TABLE value_tables(DATASOURCE VARCHAR(255) NOT NULL, NAME VARCHAR(255) NOT NULL, ENTITY_TYPE VARCHAR(255) NOT NULL, SQL_NAME VARCHAR(255) NOT NULL, PRIMARY KEY(DATASOURCE, NAME));
