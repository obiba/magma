DROP TABLE IF EXISTS test_surveys;
...
DROP TABLE IF EXISTS test_surveys_languagesettings;
CREATE TABLE test_surveys_languagesettings (
...
DROP TABLE IF EXISTS test_question_attributes;
CREATE TABLE test_question_attributes (
...
INSERT INTO test_groups (gid, sid, group_name, group_order, description, language, randomization_group, grelevance) VALUES
...
INSERT INTO test_questions (qid, parent_qid, sid, gid, type, title, question, preg, help, other, mandatory, question_order, language, scale_id, same_default, relevance) VALUES
...
INSERT INTO test_question_attributes (qaid, qid, attribute, value, language) VALUES
...
INSERT INTO test_answers (qid, code, answer, assessment_value, sortorder, language, scale_id) VALUES
...
(7, 'B1', 'option 2-1', 0, 1, 'en', 1),
(7, 'A2', 'option 1-2', 1, 2, 'en', 0),
(7, 'A2', 'option 1-2', 1, 2, 'fr', 0),
(7, 'A1', 'option 1-1', 0, 1, 'en', 0),
(7, 'A1', 'option 1-1', 0, 1, 'fr', 0),
(7, 'B1', 'option 2-1', 0, 1, 'fr', 1),
(7, 'B2', 'option 2-2', 1, 2, 'en', 1),
(7, 'B2', 'option 2-2', 1, 2, 'fr', 1),
