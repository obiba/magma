...
public class GlobalMethodsIntegrationTest extends AbstractJsTest {
  ...
  private final ViewManager viewManager = new DefaultViewManagerImpl(new MemoryViewPersistenceStrategy());
  ...
  public void test_$_vector() throws Exception {
    ...
    //noinspection ConstantConditions
    List<Value> viewValues = Lists.newArrayList(viewVectorSource.getValues(new TreeSet<>(view.getVariableEntities())));

    for(int i = 0; i < viewValues.size(); i++) {
      Long kg = (Long) tableValues.get(i).getValue();
      Long lbs = (Long) viewValues.get(i).getValue();
      assertThat(lbs).isEqualTo((long) (kg * 2.2));
    }
  ...
  @Test
  public void test_$_dependencies() throws Exception {
    Datasource datasource = getTestDatasource();
    ValueTable table = datasource.getValueTable(TABLE);
  ...
  @Test
  public void test_$_self_reference() throws Exception {
    Datasource datasource = getTestDatasource();
    ValueTable table = datasource.getValueTable(TABLE);
  ...
  @Test
  public void test_$_valueSets_with_circular_dependencies() throws Exception {
    Datasource datasource = getTestDatasource();
    ValueTable table = datasource.getValueTable(TABLE);
  ...
  @Test
  public void test_$this() throws Exception {
    Datasource datasource = getTestDatasource();
    ValueTable table = datasource.getValueTable(TABLE);
  ...
  @Test
  public void test_$this_self_reference() throws Exception {
    Datasource datasource = getTestDatasource();
    ValueTable table = datasource.getValueTable(TABLE);
  ...
  @Test
  public void test_inner_$this() throws Exception {
    Datasource datasource = getTestDatasource();
    ValueTable table = datasource.getValueTable(TABLE);
  ...
  @Test
  public void test_inner_$this_with_circular_dependencies() throws Exception {
    Datasource datasource = getTestDatasource();
    ValueTable table = datasource.getValueTable(TABLE);
