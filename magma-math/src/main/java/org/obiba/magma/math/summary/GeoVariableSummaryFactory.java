...
public class GeoVariableSummaryFactory extends AbstractVariableSummaryFactory<GeoVariableSummary> {
  ...
  @NotNull
  @Override
  public GeoVariableSummary getSummary() {
    return new GeoVariableSummary.Builder(getVariable()) //
        .filter(offset, limit) //
  ...
  public static class Builder {
    ...
    private final GeoVariableSummaryFactory factory = new GeoVariableSummaryFactory();
    ...
    public GeoVariableSummaryFactory build() {
      return factory;
    }
  }
