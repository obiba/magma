...
public class VariableConverter implements JPAConverter<VariableState, Variable> {
  ...
  @Override
  public VariableState marshal(Variable variable, JPAMarshallingContext context) {
  ...
  @Override
  public Variable unmarshal(VariableState variableMemento, JPAMarshallingContext context) {
