...
public class AnnotationConfigurationHelper {
  ...
  private final Set<Class<?>> annotatedTypes = new ImmutableSet.Builder<Class<?>>().add(DatasourceState.class, VariableEntityState.class, ValueTableState.class, ValueSetState.class, ValueSetValue.class, VariableState.class, CategoryState.class, AttributeState.class).build();
